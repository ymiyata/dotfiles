...
alias vimrc="$EDITOR $DOTFILES_VIMDIR/vimrc.vim"
alias vimrcp="$EDITOR $DOTFILES_VIMDIR/vimrc.plugin.vim"
alias vimrcn="$EDITOR $DOTFILES_VIMDIR/vimrc.neobundle.vim"
